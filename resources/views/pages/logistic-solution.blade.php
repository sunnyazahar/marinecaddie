                    ...
                    <div class="col-lg-8 mt-2-9 order-1 order-lg-2">
                        <div>
                            <div class="mb-2-6 image-hover wow fadeInUp" data-wow-delay="100ms">
                                <img src="{{ theme_asset('assets/img/services/service-detail-05.jpg') }}" alt="MarineCaddie — Ship Spares Logistics" title="MarineCaddie — Ship Spares Logistics" class="rounded">
                            </div>
