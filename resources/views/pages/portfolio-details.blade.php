                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="position-relative mb-1-9 mb-sm-2-9 image-hover wow fadeInUp" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeInUp;">
                            <img src="{{ theme_asset('assets/img/portfolio/portfolio-details-01.jpg') }}" alt="MarineCaddie — portfolio project showcase" title="MarineCaddie — portfolio project showcase" class="rounded">
                        </div>
                        ...
                        <div class="row mb-1-9 mb-sm-6 mt-n4 wow fadeInUp" data-wow-delay="200ms">
                            <div class="col-6 col-lg-3 mt-4">
                                <div class="image-hover">
                                    <img src="{{ theme_asset('assets/img/portfolio/portfolio-detail-01.jpg') }}" alt="MarineCaddie — portfolio gallery image" title="MarineCaddie — portfolio gallery image" class="rounded">
                                </div>
                            </div>
                            <div class="col-6 col-lg-3 mt-4">
                                <div class="image-hover">
                                    <img src="{{ theme_asset('assets/img/portfolio/portfolio-detail-02.jpg') }}" alt="MarineCaddie — portfolio gallery image" title="MarineCaddie — portfolio gallery image" class="rounded">
                                </div>
                            </div>
                            <div class="col-6 col-lg-3 mt-4">
                                <div class="image-hover">
                                    <img src="{{ theme_asset('assets/img/portfolio/portfolio-detail-03.jpg') }}" alt="MarineCaddie — portfolio gallery image" title="MarineCaddie — portfolio gallery image" class="rounded">
                                </div>
                            </div>
                            <div class="col-6 col-lg-3 mt-4">
                                <div class="image-hover">
                                    <img src="{{ theme_asset('assets/img/portfolio/portfolio-detail-04.jpg') }}" alt="MarineCaddie — portfolio gallery image" title="MarineCaddie — portfolio gallery image" class="rounded">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="prev-page">
                                <div class="page-info">
                                    <a href="{{ route('portfolio.details') }}#">
                                        <span class="image-prev"><img src="{{ theme_asset('assets/img/portfolio/prev-project.jpg') }}" alt="MarineCaddie — Country House Cleaning"></span>
                            ...
                            <div class="next-page">
                                <div class="page-info">
                                    <a href="{{ route('portfolio.details') }}#">
                                        ...
                                        <span class="image-next"><img src="{{ theme_asset('assets/img/portfolio/next-project.jpg') }}" alt="MarineCaddie — Take Care Of Your Furniture"></span>
                                    </a>
                                </div>
                            </div>
                        </div>
