...
<head>
    ...
    <link rel="preload" href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260925svc13" as="style">
    ...
    <link href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260925svc13" rel="stylesheet">
