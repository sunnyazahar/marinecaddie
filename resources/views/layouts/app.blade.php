...
<head>
    ...
    <link rel="preload" href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260924txt1" as="style">
    ...
    <link href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260924txt1" rel="stylesheet">
