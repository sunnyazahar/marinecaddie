...
<head>
    ...
    <link rel="icon" type="image/png" sizes="96x96" href="{{ theme_asset('assets/img/logos/favicon-96x96.png') }}?v=mc10">
    ...
    <link rel="preload" href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260925door2" as="style">
    ...
    <link href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260925door2" rel="stylesheet">
