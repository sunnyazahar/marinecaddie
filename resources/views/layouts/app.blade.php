...
<head>
    ...
    @endif
    <link rel="preload" href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260825cls3" as="style">
    ...
    <link href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260825cls3" rel="stylesheet">
    <link rel="stylesheet" href="{{ theme_asset('assets/css/fonts-local.css') }}?v=20260825cls3" media="print" onload="this.media='all'">
    <link rel="stylesheet" href="{{ theme_asset('assets/css/plugins.css') }}?v=20260825cls3" media="print" onload="this.media='all'">
    <noscript>
        <link rel="stylesheet" href="{{ theme_asset('assets/css/fonts-local.css') }}?v=20260825cls3">
        <link rel="stylesheet" href="{{ theme_asset('assets/css/plugins.css') }}?v=20260825cls3">
    </noscript>
