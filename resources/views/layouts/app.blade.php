...
<head>
    ...
    @endif
    <link rel="preload" href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260825tbt2" as="style">
    ...
    <link href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260825tbt2" rel="stylesheet">
    <link rel="stylesheet" href="{{ theme_asset('assets/css/fonts-local.css') }}?v=20260825tbt2" media="print" onload="this.media='all'">
    <link rel="stylesheet" href="{{ theme_asset('assets/css/plugins.css') }}?v=20260825tbt2" media="print" onload="this.media='all'">
    <noscript>
        <link rel="stylesheet" href="{{ theme_asset('assets/css/fonts-local.css') }}?v=20260825tbt2">
        <link rel="stylesheet" href="{{ theme_asset('assets/css/plugins.css') }}?v=20260825tbt2">
    </noscript>
...
<body>
    ...
    {{-- Early: tiny vanilla helpers only (cuts mobile TBT from jQuery/Bootstrap parse) --}}
    <script src="{{ theme_asset('assets/js/perf-lazy.js') }}?v=20260825tbt2" defer></script>
    <script type="text/plain" data-mc-quote-src="{{ theme_asset('assets/js/quote-modal.js') }}?v=20260825tbt2"></script>

    {{-- After window load — jQuery/Bootstrap/theme (was ~174KB+ early parse on mobile) --}}
    <script type="text/plain" data-mc-defer-src="{{ theme_asset('assets/js/jquery.min.js') }}"></script>
    ...
    <script type="text/plain" data-mc-defer-src="{{ theme_asset('assets/js/nav-mobile.js') }}?v=20260823perf1"></script>
    <script type="text/plain" data-mc-defer-src="{{ theme_asset('assets/js/contact-form.js') }}?v=20260823faq1"></script>
    <script type="text/plain" data-mc-defer-src="{{ theme_asset('assets/js/quote-modal.js') }}?v=20260825tbt2"></script>
    <script type="text/plain" data-mc-defer-src="{{ theme_asset('assets/js/core.min.js') }}"></script>
    <script type="text/plain" data-mc-defer-src="{{ theme_asset('assets/js/main.js') }}?v=20260825tbt2"></script>
    ...
    @endif
    <script src="{{ theme_asset('assets/js/defer-bundle.js') }}?v=20260825tbt2" defer></script>
    ...
    <script>
      window.addEventListener('load', function () {
        ...
        if ('requestIdleCallback' in window) {
          requestIdleCallback(boot, { timeout: 12000 });
        } else {
