...
<head>
    ...
    <link rel="preload" href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260923cin10" as="style">
    ...
    <link href="{{ theme_asset('assets/css/styles.min.css') }}?v=20260923cin10" rel="stylesheet">
